...
function Registry_Data_Two({ x, togglePage }){
                    ...
                    <div className='col'>
                        ...
                        <div className='col-12 h-100'>
                            <div className='row h-50 p-0 m-0 h-30'>
                                ...
                                <div className='col-6 d-flex flex-column align-items-center btVert-alignment mt-5'>
                                    <button onClick={handleConfirmationClick} type='button' className='btn btn-primary button-bg w-50 px-0 text-center fs-sm'>Bestätigen</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default Registry_Data_Two;