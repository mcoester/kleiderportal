            ...
            <div className='col-sm-8 col-11 bgColor rounded-5'>
                <div className='row h-25 align-items-center'>
                    <div className='col'>
                        ...
                        <h3 className='text-center fs-5'>Abholung per Sammelfahrzeug</h3>
                    </div>
                </div>
                <form className='h-75'>
                    <div className='row h-100'>
                        <div className='col-12'>
                            <fieldset>
                                <legend className='fs-6 m-0'>Adresse:</legend>
                        ...
                        <div className='col d-flex flex-column' id='selectContainer'>
                            <label htmlFor='typeOfClothing' className='fs-6'>Art der Kleidung:</label>
                            ...
                            <label className='mt-4 fs-6' htmlFor='crisisArea'>In welches Krisengebiet soll deine Spende geschickt werden?</label>
                            <select onChange={changeAreaHandler} value={crisisArea} className="form-select mt-1" aria-label="To which crisis area should the clothing donation go?" id='crisisArea' required>
                                <option value=''>-- Bitte wählen --</option>
